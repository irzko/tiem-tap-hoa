...
CREATE TABLE "OrderItemStatus" (
    ...
    CONSTRAINT "OrderItemStatus_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "PaymentItem" ADD CONSTRAINT "PaymentItem_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "OrderItemStatus" ADD CONSTRAINT "OrderItemStatus_orderItemId_fkey" FOREIGN KEY ("orderItemId") REFERENCES "OrderItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
