...
function AddSupplierForm({ onClose }: { onClose: () => void }) {
  ...
  return (
    <>
      <div>
        <ModalHeader title="Thêm nhà cung cấp" onClose={onClose} />
        <form
        ...
        >
          ...
          <InputField label="Địa chỉ" id="address" name="address" />
          <InputField
...
export default function Suppliers() {
  ...
  const { data } = useSWR(`/api/suppliers`, supplierFetcher, {
    ...
    <>
      <div className="max-w-screen-md mx-auto flex flex-col">
        <div className="mb-4  self-end">
          <Button
            onClick={() =>
              showModal((onClose) => <AddSupplierForm onClose={onClose} />)
            }
          >
            Thêm nhà cung cấp
          </Button>
