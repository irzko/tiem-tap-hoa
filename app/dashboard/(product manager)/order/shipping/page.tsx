...
const columns = [
  ...
  { name: "GIÁ", uid: "totalAmount", sortable: true },
...
//   const { data: orders } = useSWR("/api/orders/shipping", fetcher, {
...
//       <CardHeader>Đơn hàng đang chờ lấy</CardHeader>
//       <Divider />
